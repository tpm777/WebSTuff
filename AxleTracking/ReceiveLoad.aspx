<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceiveLoad.aspx.cs" Inherits="ReceiveLoad" %>
...
<body bgcolor="#99ffff" onload="OnPageRLoadLoad();">
    ...
    <div>
        <div style="z-index: 101; left: 2px; width: 320px; position: absolute; top: 3px;
            ...
            &nbsp; &nbsp;&nbsp;
            <asp:Label ID="lblTitle" runat="server" Style="z-index: 101; left: 120px; position: absolute;
                top: 4px" Text="Receive Load" Width="85px"></asp:Label>
            ...
            &nbsp;
            <asp:Label ID="lblQuantity" runat="server" Height="8px" Style="z-index: 105; left: 7px;
                position: absolute; top: 52px" Text="Quantity :" Width="64px"></asp:Label>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <asp:TextBox ID="txbQuantity" runat="server" Style="z-index: 106; left: 94px; position: absolute;
                top: 51px" Width="66px"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <mbcbb:combobox id="cmbCustomers" runat="server" datasourceid="SqlDataSource1" datatextfield="Customer_Name"
                datavaluefield="Customer_Name" style="z-index: 111; left: 95px; position: absolute;
                top: 25px" width="164px"><asp:ListItem>Databound</asp:ListItem>
</mbcbb:combobox>
        </div>
        <br />
        <br />
